...
import io.kuberig.gradle.tasks.encryption.*
import io.kuberig.gradle.tasks.registerEnvironmentTask
...
open class KubeRigPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        project.afterEvaluate {
            ...
            it.dependencies.add(
                    "implementation",
                    "io.kuberig:kuberig-core:$kuberigVersion"
            )
            it.dependencies.add(
                    "implementation",
                    "io.kuberig:kuberig-annotations:$kuberigVersion"
            )
            it.dependencies.add(
                    "implementation",
                    "io.kuberig:kuberig-dsl-support:$kuberigVersion"
            )
            it.dependencies.add(
                    "implementation",
